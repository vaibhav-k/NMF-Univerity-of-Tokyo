...
X = pd.read_csv(
    r"C:/Users/Vaibhav/nmf/inputs/input_small_data_DRUG.zero-one.csv",
    index_col=0,
    header=0,
    na_values="NaN",
)
...
Y = pd.read_csv(
    r"C:/Users/Vaibhav/nmf/inputs/input_small_data_MUT.zero-one.csv",
    index_col=0,
    header=0,
    na_values="NaN",
)
...
Z = pd.read_csv(
    r"C:/Users/Vaibhav/nmf/inputs/input_small_data_PROT.zero-one.csv",
    index_col=0,
    header=0,
    na_values="NaN",
    encoding="ISO-8859-1",
